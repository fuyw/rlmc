...
class MultiWaveletCross(nn.Module):
    ...
    def __init__(self,
        ...
        self.attn1 = FourierCrossAttentionW(in_channels=in_channels,
        ...
        self.attn2 = FourierCrossAttentionW(in_channels=in_channels, 
                                            out_channels=out_channels,
                                            seq_len_q=seq_len_q,
                                            seq_len_kv=seq_len_kv,
                                            modes=modes,
                                            activation=activation,
                                            mode_select_method=mode_select_method)
        self.attn3 = FourierCrossAttentionW(in_channels=in_channels, 
                                            out_channels=out_channels,
                                            seq_len_q=seq_len_q,
                                            seq_len_kv=seq_len_kv,
                                            modes=modes,
                                            activation=activation,
                                            mode_select_method=mode_select_method)
        self.attn4 = FourierCrossAttentionW(in_channels=in_channels,
                                            out_channels=out_channels,
                                            seq_len_q=seq_len_q,
                                            seq_len_kv=seq_len_kv,
                                            modes=modes,
    ...
    def forward(self, q, k, v, mask=None):
        B, N, _, _ = q.shape  # (B, N, H, E) torch.Size([3, 768, 8, 2])
...
class FourierCrossAttentionW(nn.Module):
    ...
    def forward(self, q, k, v, mask):
        ...
        xq = q.permute(0, 3, 2, 1)  # size = [B, H, E, L], ([3, 8, 64, 512])
